...
def preprocess_data(in_file, out_file):
    col_key1 = {"admin.": 0, "unknown": 1, "unemployed": 2, "management": 3, "housemaid": 4, "entrepreneur": 5,
    ...
    col_key3 = {"basic.4y": 16, "basic.6y": 17, "basic.9y": 18, "high.school": 19, "illiterate": 20,
                "professional.course": 21, "university.degree": 22, "unknown": 23}
    ...
    col_key8 = {"jan": 35, "feb": 36, "mar": 37, "apr": 38, "may": 39, "jun": 40, "jul": 41, "aug": 42, "sep": 43,
                "oct": 44, "nov": 45, "dec": 46}
    ...
    for l in in_file:
        ...
        for col in empty_cols:
            newline += str(col) + ","
        newline += line[11] + "," + line[12] + "," + line[13] + "," + line[15] + "," + line[16] + "," + line[17] + "," + \
                   line[18] + "," + line[19] + "," + str(col_key11[line[20]]) + "\n"
